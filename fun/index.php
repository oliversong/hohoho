...
elseif (3.9 < $g && $g<= 4.2){
	echo "<div style='width:100%;height:100%;'><div style='font-size:50px;font-family:Helvetica;position:relative;top:35%;width:100%;text-align:center;'>WELL SHIT PRETTY FUCKING WORTH WATCHING.</div><form style='position:relative;left:50%;margin-left:-225px;top:40%;width:500px;' action='http://www.olli.es/fun/index.php'><button type='submit' style='height:40px;width:450px;font-size:30px;font-family:helvetica;'>ANOTHER FUCKING MOVIE</button></form></div>";
}
elseif (3.6 < $g && $g <= 3.9){
